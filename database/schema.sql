...
('site_name', 'Волшебная ЛАВКА', 'Название сайта'),
('site_description', 'Магический магазин для всех волшебников', 'Описание сайта'),
('site_keywords', 'магия, заклинания, зелья, артефакты', 'Ключевые слова для SEO'),
('contact_email', 'info@magic.shop', 'Контактный email'),
('contact_phone', '+7 (999) 123-45-67', 'Контактный телефон'),
('delivery_info', 'Доставка по всей волшебной стране', 'Информация о доставке'),
('return_policy', 'Возврат в течение 14 дней', 'Политика возврата'),
('background_image', '/images/background/fon.jpg', 'Фоновое изображение сайта'),
('site_font', 'Arial', 'Основной шрифт сайта'),
('favicon', '/images/favicon.svg', 'Фавикон сайта');
