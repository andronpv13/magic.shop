...
<section class="section"><div class="container">
    ...
    <div class="order-card">
        <div class="order-header">
            <div><span class="order-number">Заказ №<?php echo e($order['id']); ?></span><span> - </span><span class="order-date"><?php echo date('d.m.Y H:i', strtotime($order['created_at'])); ?></span></div>
        ...
        <div class="order-items-preview">
            ...
            <div class="order-item-preview"><span><?php echo e($item['product_name']); ?></span><span> - <?php echo $item['quantity']; ?> шт.</span></div>
            <?php endforeach; ?>
        </div>
