<?php
/**
 * Детали заказа "Волшебная ЛАВКА"
 * Разработчик: АВВА © 2025
 */

$page_title = 'Детали заказа - Админ-панель';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_status'])) {
    ...
    if (!in_array($new_status, $allowed_statuses)) {
        ...
        $result = updateOrderStatusAdmin($order_id, $new_status);
...
<section class="section">
    <div class="container">
        <nav class="breadcrumbs">
            ...
            <a href="manage_orders.php">Заказы</a>
            <span class="separator">/</span>
        ...
        <a href="manage_orders.php" class="back-link">← Назад к заказам</a>
    </div>
</section>
